...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nintondo: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a nintondo: URI or payment request"));
