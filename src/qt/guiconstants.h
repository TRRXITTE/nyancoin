...
#define QAPP_ORG_NAME "Nintondo"
#define QAPP_ORG_DOMAIN "nintondo-nyan.com"
#define QAPP_APP_NAME_DEFAULT "Nintondo-Qt"
#define QAPP_APP_NAME_TESTNET "Nintondo-Qt-testnet"
